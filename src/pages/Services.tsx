      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            return <Card key={index} className="relative overflow-hidden hover:shadow-lg transition-shadow h-full">
                  <CardHeader>
                  ...
                  <CardContent className="flex-1">
                    ...
                    <div className="mb-4">
                      ...
                      <div className="flex flex-wrap gap-1">
                        {service.certifications.map(cert => <Badge key={cert} variant="outline" className="text-xs">
                            {cert}
                          </Badge>)}
                      </div>
                    </div>
